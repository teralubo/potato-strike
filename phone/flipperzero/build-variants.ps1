...
$variants = @(
  @{ Name = "official"; Index = "https://update.flipperzero.one/firmware/directory.json"; Output = "PotatoStrikeMini-1.1-BETA-official.fap" },
  @{ Name = "momentum"; Index = "https://up.momentum-fw.dev/firmware/directory.json"; Output = "PotatoStrikeMini-1.1-BETA-momentum.fap" },
  @{ Name = "unleashed"; Index = "https://up.unleashedflip.com/directory.json"; Output = "PotatoStrikeMini-1.1-BETA-unleashed.fap" }
)
