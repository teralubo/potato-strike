...
const simple3dTextures = {
  white: { base: "#f0f0e6", side: "#d1d4c8", seam: "rgba(35,35,31,0.24)", mark: "rgba(255,255,255,0.28)", mode: "panel", footstep: "concrete" },
  concrete: { base: "#d2d5cb", side: "#aeb7ad", seam: "rgba(45,45,40,0.26)", mark: "rgba(255,255,255,0.18)", mode: "panel", footstep: "concrete" },
  brick: { base: "#cda47f", side: "#91664e", seam: "rgba(65,38,28,0.34)", mark: "rgba(255,245,220,0.16)", mode: "brick", footstep: "stone" },
  crate: { base: "#b88752", side: "#745032", seam: "rgba(49,30,17,0.36)", mark: "rgba(255,230,176,0.18)", mode: "crate", footstep: "wood" },
  metal: { base: "#b9c5c9", side: "#74868c", seam: "rgba(22,35,38,0.32)", mark: "rgba(255,255,255,0.24)", mode: "metal", footstep: "metal" },
...
function materialAt(x, y) {
  const hit = state.map.obstacles.find((o) => x >= o.x && x <= o.x + o.w && y >= o.y && y <= o.y + o.h);
...
function draw3dTerrain(w, h, horizon = h / 2) {
  ...
  floor.addColorStop(0, "#68775e");
  floor.addColorStop(0.5, simple3dTextures.terrain.base);
  floor.addColorStop(1, "#223024");
  ctx.fillStyle = floor;
...
function draw3dCharacter(x, y, size, color) {
  ...
  ctx.strokeRect(x - size * 0.26, y - size * 0.49, size * 0.52, size * 0.7);
  ctx.strokeStyle = "rgba(14,16,13,0.78)";
